...
function onStepHit()
    if curStep >= 256 and curStep < 801 and curStep % 4 == 0 then
        triggerEvent('Add Camera Zoom', '0.030', '0.06')
    elseif curStep >= 928 and curStep < 1185 and curStep % 4 == 0 then
        triggerEvent('Add Camera Zoom', '0.030', '0.06')
    elseif curStep >= 1376 and curStep < 1441 and curStep % 4 == 0 then
        triggerEvent('Add Camera Zoom', '0.030', '0.06')
    elseif curStep >= 1472 and curStep < 2241 and curStep % 4 == 0 then
        triggerEvent('Add Camera Zoom', '0.030', '0.06')
    end
end
...
function onCreatePost()
    precacheChart()
    precacheEvents()
    precacheScript('data/god-eater-retrospecter/GodShaggyScreen')
    precacheScript('data/god-eater-retrospecter/noteFlyingGOD')
    precacheScript('data/god-eater-retrospecter/ShaggyEventsLOL')
end
